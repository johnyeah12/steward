...
const OCR = (() => {
  ...
  const CAT_HINTS = [
    ['groc', /WELLCOME|PARKNSHOP|PARK\s*N\s*SHOP|MARKET\s*PLACE|JASONS|CITY\s*SUPER|759|AEON|VANGUARD|FUSION|GREAT|SUPERMARKET|GROCER|FRESH|市場|超級|超市/i],
    ['food', /RESTAURANT|CAFE|COFFEE|STARBUCKS|PACIFIC\s*COFFEE|MCDONALD|KFC|SUBWAY|PIZZA|BURGER|NOODLE|DIM\s*SUM|BAR\b|BISTRO|KITCHEN|DELIVEROO|FOODPANDA|UBER\s*EATS|TEA\b|BAKERY|CHA\s*CHAAN|茶餐廳|飯|麵|餐廳|咖啡/i],
    ['tran', /MTR|OCTOPUS|TAXI|UBER|BUS\b|FERRY|TRAM|PARKING|PETROL|SHELL|CALTEX|ESSO|AIRPORT\s*EXPRESS|八達通|的士|停車/i],
    ['heal', /WATSONS|MANNINGS|PHARMACY|CLINIC|HOSPITAL|DENTAL|DOCTOR|MEDICAL|OPTICAL|藥房|診所|醫/i],
    ['home', /IKEA|HOME|FURNITURE|HARDWARE|JAPAN\s*HOME|DAISO|MUJI|PRICERITE|家居/i],
    ['bill', /HKT|PCCW|CSL|SMARTONE|THREE|CLP|TOWNGAS|WATER\s*SUPPL|ELECTRIC|BROADBAND|NETFLIX|SPOTIFY|SUBSCRIPTION|INVOICE|BILL\b/i],
    ['fun',  /CINEMA|MOVIE|BROADWAY|UA\b|GOLDEN\s*HARVEST|KARAOKE|GAME|THEATRE|CONCERT|BOOK|HMV/i],
    ['pers', /SALON|BARBER|HAIR|SPA\b|NAIL|COSMETIC|SASA|BONJOUR|SEPHORA|UNIQLO|ZARA|H&M|MUJI\s*CLOTH/i],
    ['trip', /HOTEL|AIRLINE|CATHAY|HK\s*EXPRESS|AIRWAYS|TRAVEL|AGODA|BOOKING\.COM|AIRBNB|EXPEDIA/i],
    ['kids', /TOY|KIDS|CHILD|BABY|MOTHERCARE|SCHOOL|TUTOR/i],
  ];
